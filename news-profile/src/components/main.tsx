/**
 * v0 by Vercel.
 * @see https://v0.dev/t/eOTUukeseRI
              ...
              <div className="flex flex-row space-x-4">
                ...
                <div className="w-1/2 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Designed and implemented responsive user interfaces using modern front-end technologies. Optimized
                      web applications for performance and accessibility.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-row space-x-4">
                ...
                <div className="w-1/2 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Gained experience in full-stack web development, participating in the implementation of various
              ...
              <div className="flex flex-row space-x-4">
                ...
                <div className="w-1/2 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Collaborated with a team to build a university website, gaining hands-on experience in web
                      development.
                    </p>
                  </div>
                </div>
